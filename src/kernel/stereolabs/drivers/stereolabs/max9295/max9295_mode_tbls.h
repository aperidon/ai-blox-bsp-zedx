...
#define MAX9295_DRIVER_VERSION_PATCH 3
...
#define GMSL_8BIT_MODE 	  0x6A

#define MAX9295_MFP8_GPIO_A   0x02D6 /* mono (9295A) trigger */
#define MAX9295_MFP9_GPIO_A   0x02D9 /* stereo (9295D) trigger, cam 0 */
#define MAX9295_MFP10_GPIO_A  0x02DC /* stereo (9295D) trigger, cam 1 */

#define MAX9295_FSYNC_GPIO_RX 0x04
/* GPIO_A bit0: 1 = disable output driver, gating the FSYNC pulse to the sensor. */
#define MAX9295_GPIO_OUT_DIS  0x01
...
// Configure the zedx serializer to send the video over GMSL
static struct index_reg_8 zedxnano_9295D_Ser_A[] = {
	{MAX9295D_ADDRESS_BASE, 0x0010, 0x21}, //92 reset path but not registers and auto conf
	{MAX9295D_ADDRESS_BASE, 0x0311, 0x21}, //92 start port a pipe x and port b pipe z
	{MAX9295D_ADDRESS_BASE, 0x0308, 0x7e}, //92 start mipi a and b , a get pipe x and b get pipe z
	...
	{MAX9295D_ADDRESS_BASE, 0x02BE, 0x00}, // MFP0 to low to have IMU adress @0x19/69
...
// Configure the zedx serializer to send the video over GMSL
static struct index_reg_8 zedxnano_9295D_Ser_B[] = {
	{MAX9295D_ADDRESS_BASE, 0x0010, 0x21}, //92 reset path but not registers and auto conf
	{MAX9295D_ADDRESS_BASE, 0x0311, 0x84}, //92 start port a pipe Y and port b pipe U
	{MAX9295D_ADDRESS_BASE, 0x0308, 0x7b}, //92 start mipi a and b , a get pipe x and b get pipe z
...
static struct index_reg_8 *mode_table_A[] = {
	...
	[ZEDXNANO_9295D_SER] = zedxnano_9295D_Ser_A,
};
...
static struct index_reg_8 *mode_table_B[] = {
	...
	[ZEDXNANO_9295D_SER] = zedxnano_9295D_Ser_B,
};
