...
#define MAX9295_DRIVER_VERSION_MINOR 3
#define MAX9295_DRIVER_VERSION_PATCH 0
...
#define ZEDXONEGS_TAB_SIZE (sizeof(ar0234_9295A_Ser) / sizeof(ar0234_9295A_Ser[0]))
 
// Configure the zedonegs serializer to send the video over GMSL
static struct index_reg_8 ar0234_9295A_Ser[] = {
...
#define ZEDX_TAB_SIZE (sizeof(ar0234_9295D_Ser) / sizeof(ar0234_9295D_Ser[0]))

// Configure the zedx serializer to send the video over GMSL
static struct index_reg_8 ar0234_9295D_Ser[] = {
	{MAX9295D_ADDRESS_BASE, 0x0010, 0x21}, //92 reset path but not registers and auto conf
...
#define ZEDXONE4K_TAB_SIZE (sizeof(imx678_9295A_Ser) / sizeof(imx678_9295A_Ser[0]))

// Configure the zed one uhd serializer to send the video over GMSL
static struct index_reg_8 imx678_9295A_Ser[] = {
	// Delay 100mS    }
...
#define ZEDXHDR_TAB_SIZE (sizeof(isx031_9295D_Ser) / sizeof(isx031_9295D_Ser[0]))

static struct index_reg_8 isx031_9295D_Ser[] = {
	{MAX9295D_ADDRESS_BASE, 0x0010, 0x21}, //92 reset path but not registers and auto conf
...
#define ZEDXONEHDR_TAB_SIZE (sizeof(isx031_9295A_Ser) / sizeof(isx031_9295A_Ser[0]))

static struct index_reg_8 isx031_9295A_Ser[] = {
...
static struct index_reg_8 *mode_table[] = {
	[AR0234_9295D_SER] = ar0234_9295D_Ser,
	[AR0234_9295A_SER] = ar0234_9295A_Ser,
	[IMX678_9295A_SER] = imx678_9295A_Ser,
	[ISX031_9295A_SER] = isx031_9295A_Ser,
	[ISX031_9295D_SER] = isx031_9295D_Ser,
};
